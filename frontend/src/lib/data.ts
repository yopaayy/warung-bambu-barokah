// ============================================
// WARUNG BAMBU BAROKAH — Data & Konstanta
// ============================================

export const SITE_CONFIG = {
  nama: "Warung Bambu Barokah",
  tagline: "Educafe & Resto",
  deskripsi:
    "Destinasi kuliner, wisata edukasi, dan event gathering keluarga terbesar di Blitar dengan konsep Eco-Luxury berkonsep arsitektur bambu.",
  alamat:
    "Jl. Raya Penataran, Desa Bacem, Kec. Sutojayan, Kabupaten Blitar, Jawa Timur 66152",
  telepon: "+62 822-4529-2988",
  whatsapp: "6282245292988",
  email: "info@warungbambubarokah.com",
  instagram: "https://www.instagram.com/wbb.blitar/",
  facebook: "https://www.facebook.com/people/Warung-Bambu-Barokah/61560863412659/",
  tiktok: "https://tiktok.com/@warungbambubarokah",
  googleMaps: "https://maps.app.goo.gl/warungbambubarokah",
  koordinat: { lat: -8.1234, lng: 112.1234 },
  jamOperasional: [
    { hari: "Senin - Kamis", jam: "10:00 - 21:00" },
    { hari: "Jumat - Sabtu", jam: "10:00 - 22:00" },
    { hari: "Minggu", jam: "09:00 - 22:00" },
  ],
  mapsEmbed: "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3951.123456789!2d112.123456789!3d-8.123456789!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zOMKwMDcnMjQuNCJTIDExMsKwMDcnMjQuNCJF!5e0!3m2!1sid!2sid!4v1700000000000",
} as const;
...
export const MENU_ITEMS: MenuItem[] = [
  ...
  { id: "pk6", nama: "Paket Outing Class Edukasi", deskripsi: "Edukasi Lalu Lintas, Fun Games, Pakan Ikan/Kelinci, Free Taman Bermain, Konsumsi (Chicken Katsu + Air Mineral)", harga: 65000, kategori: "paket", gambar: "/images/outing-class/outing-class-main-head-background.png", badge: "Educafe" },
];
...
export const TESTIMONI_DATA: Testimoni[] = [
  ...
  },
  {
    id: "2",
    nama: "Ibu Sari Dewi",
    peran: "Guru SD Negeri 3 Blitar",
    isi: "Outing class di WBB sangat berkesan untuk anak-anak didik saya. Mereka belajar sambil bermain di taman edukasi lalu lintas. Pasti akan kembali lagi tahun depan!",
    rating: 5,
  ...
  },
  {
    ...
    rating: 5,
    avatar: "/images/avatar/rizki.jpg",
  },
  {
    id: "4",
    nama: "Anisa Putri",
    peran: "Food Blogger",
    isi: "WBB adalah hidden gem di Blitar! Konsep Educafe & Resto-nya unik banget. Selain makanan, pemandangan kolam koi dan lorong bambunya sangat instagramable.",
    rating: 5,
    avatar: "/images/avatar/anisa.jpg",
  },
  {
    id: "5",
    nama: "Pak Haryono",
    peran: "Warga Blitar",
    isi: "Warung Bambu Barokah sudah jadi tempat langganan keluarga kami setiap akhir pekan. Anak-anak senang, orang tua pun nyaman. Harga juga sangat terjangkau.",
    rating: 4,
    avatar: "/images/avatar/haryono.jpg",
  },
];
...
export const GALERI_DATA: GaleriItem[] = [
  { id: "g1", judul: "Lorong Bambu Ikonik", kategori: "wisata", gambar: "/images/galeri/lorong-bambu.jpg", deskripsi: "Lorong bambu yang menjadi ikon Warung Bambu Barokah" },
  { id: "g2", judul: "Kolam Koi Cantik", kategori: "wisata", gambar: "/images/galeri/kolam-koi.jpg", deskripsi: "Kolam koi dengan ikan warna-warni yang memukau" },
  { id: "g3", judul: "Gurame Bakar Spesial", kategori: "kuliner", gambar: "/images/galeri/gurame-spesial.jpg", deskripsi: "Menu andalan Gurame Bakar Madu WBB" },
  { id: "g4", judul: "Paket Seafood Premium", kategori: "kuliner", gambar: "/images/galeri/seafood-premium.jpg", deskripsi: "Paket seafood segar langsung dari supplier terpercaya" },
  { id: "g5", judul: "Outing Class TK", kategori: "edukasi", gambar: "/images/galeri/outing-tk.jpg", deskripsi: "Kegiatan outing class anak TK di taman edukasi" },
  { id: "g6", judul: "Taman Lalu Lintas", kategori: "edukasi", gambar: "/images/galeri/taman-lalin.jpg", deskripsi: "Anak-anak belajar rambu lalu lintas dengan menyenangkan" },
  { id: "g7", judul: "Gathering Perusahaan", kategori: "event", gambar: "/images/galeri/gathering.jpg", deskripsi: "Acara gathering perusahaan dengan kapasitas besar" },
  { id: "g8", judul: "Ulang Tahun Anak", kategori: "event", gambar: "/images/galeri/ultah-anak.jpg", deskripsi: "Perayaan ulang tahun anak yang meriah dan berkesan" },
  { id: "g9", judul: "Suasana Sore Hari", kategori: "wisata", gambar: "/images/galeri/suasana-sore.jpg", deskripsi: "Pemandangan sunset indah dari area outdoor WBB" },
  { id: "g10", judul: "Nasi Goreng Bambu", kategori: "kuliner", gambar: "/images/galeri/nasi-goreng.jpg", deskripsi: "Nasi goreng disajikan dalam bambu yang unik" },
  { id: "g11", judul: "Workshop Kreativitas", kategori: "edukasi", gambar: "/images/galeri/workshop.jpg", deskripsi: "Workshop kreativitas untuk anak sekolah dasar" },
  { id: "g12", judul: "Live Music Weekend", kategori: "event", gambar: "/images/galeri/live-music.jpg", deskripsi: "Pertunjukan live music setiap akhir pekan" },
];
...
export const BLOG_POSTS: BlogPost[] = [
  {
    id: "b1",
    judul: "5 Menu Seafood Terbaik yang Wajib Dicoba di WBB",
    slug: "5-menu-seafood-terbaik-wbb",
    ringkasan: "Temukan 5 hidangan seafood terbaik yang menjadi favorit pengunjung Warung Bambu Barokah. Dari gurame bakar hingga udang galah premium.",
    konten: "",
    gambar: "https://images.unsplash.com/photo-1598514982205-f36b96d1e8d4?q=80&w=800&h=500&fit=crop",
    kategori: "kuliner",
    penulis: "Tim WBB",
    tanggal: "2024-11-15",
    waktuBaca: "5 menit",
  },
  {
    ...
    ringkasan: "WBB memiliki taman edukasi lalu lintas lengkap untuk anak-anak. Belajar keselamatan berkendara dengan cara yang menyenangkan.",
    konten: "",
    gambar: "https://images.unsplash.com/photo-1502086223501-7ea6ecd79368?q=80&w=800&h=500&fit=crop",
    kategori: "edukasi",
    penulis: "Tim WBB",
    tanggal: "2024-11-10",
    waktuBaca: "4 menit",
  ...
  {
    id: "b3",
    judul: "Panduan Lengkap Mengadakan Gathering di Warung Bambu Barokah",
    slug: "panduan-gathering-wbb",
    ringkasan: "Tips dan panduan lengkap untuk mengadakan acara gathering, outing perusahaan, atau family day di WBB dengan budget yang fleksibel.",
    konten: "",
    gambar: "https://images.unsplash.com/photo-1511795409834-ef04bbd61622?q=80&w=800&h=500&fit=crop",
    kategori: "event",
    penulis: "Tim WBB",
    tanggal: "2024-11-05",
    waktuBaca: "7 menit",
  ...
  {
    id: "b4",
    judul: "Menikmati Sunset di Lorong Bambu: Wisata Alam di Tengah Blitar",
    slug: "sunset-lorong-bambu-blitar",
    ringkasan: "Lorong bambu WBB bukan hanya tempat makan, tapi juga spot wisata alam yang instagramable dengan pemandangan sunset menakjubkan.",
    konten: "",
    gambar: "https://images.unsplash.com/photo-1542382156909-9ae37b3f56fd?q=80&w=800&h=500&fit=crop",
    kategori: "wisata",
    penulis: "Tim WBB",
    tanggal: "2024-10-28",
    waktuBaca: "3 menit",
